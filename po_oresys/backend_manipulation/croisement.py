...
"""
Ce script permet d'effectuer un croisement des coordonnées gps entre les annonces
présentes dans le fichier airbnb.csv et les logements sociaux présent dans 
paris_rpls_2017.csv.
Les résultats du croisement sont sauvegardés sous la forme results_radius_nbresults.csv
"""
...
#------------------------------------------------------------------------------#
    ...
    radius = 155 #mètres
    nb_results = 250 #nombre de logements sociaux maximal à checker autour de chaque annonce
...
#------------------------------------------------------------------------------#
#-------------- CROISEMENT DES REPERTOIRES AIRBNB ET RPLS ---------------------#
#------------------------------------------------------------------------------#
    ...
    results.to_csv('po_oresys/csv/results_rd{}_nb{}.csv'.format(radius, nb_results), header=True)
