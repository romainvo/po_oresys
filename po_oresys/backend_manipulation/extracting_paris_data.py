...
"""
Ce script permet d'extraire les logements sociaux sur Paris à partir d'un 
répertoire national des logements sociaux. Le fichier sera sauvegardé dans le 
dossier po_oresys/csv/
"""
...
if __name__ == '__main__':
    ...
    reader = pd.read_csv('po_oresys/csv/geo-rpls2017.csv', sep=',',error_bad_lines=False,
    ...
    paris_rpls.to_csv('po_oresys/csv/paris_rpls_2017.csv', header=True)